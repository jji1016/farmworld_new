...
public class GoodsController {
    ...
    public Map<String, String> postLogin(@RequestParam("file") MultipartFile file, HttpServletRequest request,
        ...
        try {
            ...
            // 원하는 경로에 저장하기 위해 절대 경로 설정
            String uploadDirectory = "C:/Users/keduit/Desktop/새 폴더/farmworld_new/farmworld_new/src/main/webapp/resources/upload/"; // 파일이 저장될 경로 설정
            Integer imageFolderNum = imageService.MaxFolder();
            String filePath = uploadDirectory + imageFolderNum;
            ...
            // 파일 저장
            File storedFile = new File(filePath+"/"+fileName);
            file.transferTo(storedFile);

            // 파일 위치 저장
            ImageVO imageVo = new ImageVO();
            imageVo.setImage_folder_num(goodsService.getCount());
            imageVo.setImage1(fileName);
            imageVo.setImage2("");
            imageVo.setImage3("");
